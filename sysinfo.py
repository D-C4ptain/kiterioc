...
try: 
    ...
    #Network
    print("Network")
    for x,y in net['interface_addresses'].items():
        print(Fore.GREEN, x, y[0])    
    print(info['network']["mac_addresses"])
    print(Style.RESET_ALL)

    #Peripheral devices
    print("Peripheral devices")
    for x in info['peripheral_devices']:
        print(Fore.WHITE, x)
    print(Style.RESET_ALL)
    ...
    #print(e)
    if "bios" in str(e):
        print(Fore.RED + "Permission denied! run as sudo/administrator")
        print(Style.RESET_ALL)
        sys.exit(1)
    else:
        print("error occured!")
